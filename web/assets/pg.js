...
window.PG = (function () {
  ...
  function fallbackSidebar(active) {
    ...
    [['Dashboard','/index.html','dashboard'],['Screener','/screener.html','screener'],['Backtest','/backtest.html','backtest'],['Portfolio','/portfolio.html','portfolio'],['Compare','/compare.html','compare'],['Review','/review.html','review']].forEach(function (l) {
